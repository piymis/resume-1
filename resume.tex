...
{Senior Software Engineer II}{October 2019 - Present}
\resumeItemListStart		
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
		\textbf{Languages}{: Python, C/C++, Go, SQL, Shell script)} \\
		...
		\textbf{Others}{: Git, Docker, AWS (ECS, EC2, S3, CloudWatch), Jenkins, Grafana, Sumologic, Scalyr, NewRelic} \\
	}}
\end{itemize}
